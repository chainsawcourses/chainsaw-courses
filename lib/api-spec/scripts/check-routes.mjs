...
export const EXEMPT_ROUTES = process.env.CHECK_EXEMPT_ROUTES
  ...
  : new Set([
      ...
      "GET /admin/modules",
      "GET /admin/modules/{moduleId}/pdf",
      ...
      // Deployment monitor compatibility alias; /healthz remains the canonical health endpoint.
      "GET /",
      "GET /how-to-use",
      "GET /documents/legislation",
      "GET /documents/hazards",
      ...
      "POST /admin/mock-questions/upload-audio",
      ...
      // --- Module quiz question bank — admin raw-fetch editor ---
      "GET /admin/module-quizzes",
      "POST /admin/module-quizzes",
      "PUT /admin/module-quizzes/{id}",
      "DELETE /admin/module-quizzes/{id}",
      "GET /mock-questions",
