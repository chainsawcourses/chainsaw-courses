...
export const VOCAL_EXAM_QUESTIONS: VocalQuestion[] = [
...

  {
    ...
    prompts: [{
      ...
      threshold: 2,
      keyPoints: [
        { label: "Remove and clean — tap out, wash or blow out debris", keywords: ["clean", "tap out", "wash", "blow out", "remove debris", "clean filter", "wash in warm water", "warm water with soap", "blow the dust off", "tap gently", "brush softly", "air gun", "air line", "remove", "remove the filter", "take it out"] },
...

  {
    ...
    prompts: [{
      ...
      threshold: 2,
      keyPoints: [
        { label: "Remove debris from the cylinder fins — brush or compressed air", keywords: ["remove debris", "clean fins", "clean the fins", "debris from fins", "brush", "compressed air", "fin clean", "cylinder fin", "brush all sawdust out of little gaps", "sawdust out of the gaps", "blow air through it", "tap out stuck dirt", "clean"] },
        ...
        { label: "Keep clean regularly — don't let mud or debris build up", keywords: ["keep clean", "regularly clean", "clean regularly", "don't let mud dry on it", "wipe clean when finished", "check often", "not clogged up", "regular clean", "keep it clean"] },
      ],
    }],
  },
...

  {
    ...
    prompts: [{
      ...
      keyPoints: [
        ...
        { label: "Check / clean the spark arrestor", keywords: ["spark arrestor", "spark arrester", "arrestor", "clean arrestor", "carbon build", "clean the little spark catching net", "brush the net", "carbon mesh", "clean", "clean it"] },
        { label: "Check for cracks or damage to the body", keywords: ["crack", "damage", "body crack", "check damage", "inspect exhaust", "look for cracks or holes", "cracks or holes", "rusted through", "inspect", "inspect it"] },
...

  {
    ...
    prompts: [{
      ...
      keyPoints: [
        ...
        { label: "Remove, inspect and clean or replace the fuel filter", keywords: ["remove filter", "replace fuel filter", "clean filter", "new filter", "change filter", "use a little hook to pull it out", "hook to pull it out", "change once a year", "if dirty or blocked", "can't clean it just replace", "remove", "inspect", "replace", "clean", "change"] },
      ],
    }],
  },

  {
    ...
    prompts: [{
      ...
      keyPoints: [
        ...
        { label: "Remove, inspect and clean or replace the oil filter", keywords: ["remove oil filter", "replace oil filter", "clean oil filter", "new oil filter", "change oil filter", "hook it out like gas filter", "sometimes wash in clean gas", "sticky and dirty put new one in", "chain gets enough slippery oil", "remove", "inspect", "replace", "clean", "change"] },
      ],
    }],
  },
...

  {
    ...
    prompts: [{
      ...
      keyPoints: [
        ...
        { label: "Listen for clanking or rattling noises", keywords: ["clanking", "rattling", "noise", "listen for", "clank", "rattle", "listen"] },
      ],
    }],
  },
