...
export const VOCAL_EXAM_QUESTIONS: VocalQuestion[] = [
  {
    ...
    threshold: 5,
    keyPoints: [
      { label: "Identify the hazards", keywords: ["identif", "hazard", "danger", "find", "spot"] },
      { label: "Decide who might be harmed and how", keywords: ["who might", "harmed", "harm", "injur", "affected", "at risk"] },
      { label: "Evaluate the risks and decide on precautions", keywords: ["evaluat", "precaution", "control", "assess", "weigh"] },
      { label: "Record the findings and implement them", keywords: ["record", "implement", "document", "write", "log"] },
      { label: "Review and update the assessment", keywords: ["review", "update", "revise", "monitor", "revisit"] },
    ],
  },
  {
    id: 2,
    ...
    threshold: 9,
    keyPoints: [
      { label: "Site: uneven or slippery ground", keywords: ["uneven", "slippery", "ground", "terrain", "slope", "muddy"] },
      { label: "Site: other people or public in the area", keywords: ["public", "people", "bystander", "other person", "exclusion", "others nearby"] },
      { label: "Site: overhead hazards (power lines, branches)", keywords: ["overhead", "power line", "electric", "cable", "hung up", "branch above"] },
      { label: "Site: underground services", keywords: ["underground", "buried", "pipe", "service", "cable below"] },
      { label: "Site: adverse weather conditions", keywords: ["weather", "wind", "rain", "visibility", "lightning", "frost", "ice"] },
      { label: "Task: kickback during cutting", keywords: ["kickback", "kick back", "kick-back"] },
      { label: "Task: falling timber or snags", keywords: ["falling", "snag", "widow maker", "dead wood", "hung", "log roll"] },
      { label: "Task: fatigue or working alone", keywords: ["fatigue", "tired", "alone", "lone working", "exhaustion"] },
      { label: "Task: dust, noise or vibration from the task", keywords: ["dust", "noise", "vibration", "havs", "hand arm", "white finger"] },
      { label: "Machine: chain break or throw", keywords: ["chain break", "chain throw", "chain snap", "derail", "chain off"] },
      { label: "Machine: fuel spillage or fire risk", keywords: ["fuel", "spillage", "fire", "ignit", "flammable", "petrol"] },
      { label: "Machine: exhaust fumes or burns", keywords: ["exhaust", "fume", "emission", "carbon monoxide", "burn", "hot"] },
      { label: "Machine: chain brake failure", keywords: ["brake fail", "brake malfunction", "brake not work", "brake defect"] },
      { label: "Machine: vibration from the chainsaw", keywords: ["machine vibration", "saw vibration", "vibrat"] },
      { label: "Machine: contact with bar or chain", keywords: ["contact", "bar contact", "chain contact", "cut hand", "leg contact"] },
    ],
  },
  {
    id: 3,
    ...
    keyPoints: [
      ...
      { label: "Designated meeting place", keywords: ["meeting place", "muster point", "rendezvous", "rally point", "assembly"] },
      { label: "Nearest access point or street name", keywords: ["access point", "street", "access route", "entry point", "nearest road"] },
      { label: "Type of access (road/4WD/vehicle type)", keywords: ["type of access", "four wheel", "4x4", "vehicle", "road access", "public road", "light vehicle"] },
      ...
      { label: "Works manager contact details", keywords: ["works manager", "supervisor contact", "manager", "emergency contact", "contact details"] },
      { label: "Your own contact number or mobile", keywords: ["own number", "mobile number", "your number", "personal contact", "your mobile"] },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { label: "Regional forestry bodies", keywords: ["forestry commission", "regional forestry", "natural resources", "forestry england", "forestry body"] },
  ...
  },
  {
    id: 11,
    nptcRef: 12,
    question: "Explain the function and maintenance requirements of the individual chainsaw components — spark plug, air filter, chain brake, cooling system, exhaust system, clutch/drive system, sprocket, starter mechanism, fuel filter and oil filter.",
    threshold: 7,
    keyPoints: [
  ...
  },
  {
    ...
    threshold: 4,
    keyPoints: [
      { label: "Function: holds and carries the chain to enable cutting", keywords: ["holds the chain", "carries the chain", "carry the chain", "enable cutting", "support chain", "bar carry"] },
      { label: "Checking for uneven/damaged rails and maintaining", keywords: ["uneven rail", "damaged rail", "rail check", "rail condition", "burr", "burred"] },
      { label: "Checking straightness of bar and bar groove depth", keywords: ["straightness", "straight", "groove depth", "groove", "bar groove", "groove check"] },
      { label: "Clearing bar groove and oil holes; check sprocket nose", keywords: ["oil hole", "groove clear", "sprocket nose", "clear groove", "clean hole"] },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { label: "Application depends on timber type, experience and preference", keywords: ["timber type", "application", "experience", "preference", "wood type", "operator prefer", "species"] },
    ],
  },
  {
    id: 16,
    ...
    threshold: 5,
    keyPoints: [
      { label: "Select correct file size using chain charts/manufacturer info/chain box", keywords: ["file size", "chain chart", "manufacturer", "chain box", "correct file", "filing guide"] },
      { label: "Reason: ensures chain sharpened to manufacturer's recommendations", keywords: ["manufacturer recommendation", "correct angle", "to spec", "manufacturer spec", "as recommended"] },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { label: "Check cutters for damage; select first cutter to sharpen", keywords: ["check cutter", "damaged cutter", "first cutter", "inspect cutter", "cutter damage"] },
      { label: "Secure chain in vice; use correct file with handle", keywords: ["vice", "chain vice", "bench vice", "secure chain", "file with handle", "correct size file"] },
  ...
  },
  {
    ...
    threshold: 1,
    keyPoints: [
      { label: "Disinfection or cleaning of equipment to prevent cross-contamination", keywords: ["disinfect", "clean equipment", "cross-contamination", "cross contamination", "decontaminat"] },
  ...
  },
  {
    id: 25,
    nptcRef: 34,
    question: "State the recognised methods required to cross-cut timber — covering timber under no tension or compression, under tension and compression, under extreme tension or compression, and timber above guidebar length.",
    threshold: 4,
    keyPoints: [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { label: "Operators working in a pattern to prevent unnecessary repetitive movements", keywords: ["pattern", "repetitive", "avoid repetitive", "work pattern", "systematic", "reduce repetition"] },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { label: "Use of aid tools (timber tongs, cant hook, handsaw)", keywords: ["aid tool", "cant hook", "timber tong", "handsaw", "log tong", "tool assist", "hook"] },
