...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      {
        title: "FISA — Operational Guidance Hub",
        description: "The Forest Industry Safety Accord's full library of Operational Guidance (OG) notes covering chainsaw use, felling, extraction, windblown trees, and more. The OG series is the primary source of practical safety guidance for forestry and arboriculture in the UK.",
        url: "https://www.fisa.org.uk/guidance/operational-guidance/",
        type: "FISA Guidance",
      },
      {
        title: "FISA OG 14 — Use of a Chainsaw for Cross-cutting and Stacking",
        description: "The definitive FISA operational guidance note for cross-cutting and stacking timber with a chainsaw. Covers safe working distances, tension and compression assessment, cutting sequences, stacking heights, and manual handling of logs. Directly supports the cross-cutting and stacking modules in this course.",
        url: "https://www.fisa.org.uk/guidance/operational-guidance/14-use-of-a-chainsaw-for-cross-cutting-and-stacking/",
        type: "FISA Guidance",
      },
      {
        title: "FISA OG 20 — Processing Windblown Trees",
        description: "FISA guidance on the specific hazards of processing windblown and storm-damaged trees, including stored energy, root plates, and sequencing of cuts. Directly supports the Windblown Trees extension module in this course.",
        url: "https://www.fisa.org.uk/guidance/operational-guidance/20-processing-windblown-trees/",
        type: "FISA Guidance",
      },
      {
        title: "FISA OG 6 — Use of a Chainsaw from a Rope and Harness",
        description: "FISA guidance for arboricultural chainsaw use at height, including harness compatibility with chainsaw PPE, kickback management at height, and emergency procedures. Relevant to operators progressing into aerial tree work.",
        url: "https://www.fisa.org.uk/guidance/operational-guidance/6-use-of-a-chainsaw-from-a-rope-and-harness/",
        type: "FISA Guidance",
      },
    ],
  },
