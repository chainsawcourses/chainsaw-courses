...
export default function PracticalGateway() {
  ...
  if (!IS_DEMO && !examPassed && !passportLoading) {
    return (
  ...
  if (!IS_DEMO && !passportLoading && !passport) {
    return (
      ...
      <header className="border-b border-border bg-card/60 backdrop-blur sticky top-0 z-10">
        <div className="max-w-5xl mx-auto grid h-14 grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 px-4">
          ...
          <div className="flex min-w-0 items-center justify-self-center gap-1.5 sm:gap-2">
            ...
            <span className="truncate font-mono text-[11px] font-bold uppercase tracking-wide sm:text-xs">Practical Progression Gateway</span>
          </div>
              ...
              <Card className="border-border bg-card/80">
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    ...
                    {!IS_DEMO && <div className="font-mono">{selectedVenue.phone}</div>}
                    {!IS_DEMO && <div className="truncate">{selectedVenue.email}</div>}
                  </div>
                  ...
                  {IS_DEMO ? (
                    <p className="text-[10px] text-muted-foreground font-mono leading-relaxed italic">
                      Contact details and booking available to registered students.
                    </p>
