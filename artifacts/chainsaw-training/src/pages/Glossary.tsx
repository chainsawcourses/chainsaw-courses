...
const TERMS: { term: string; definition: string; category: string }[] = [
  ...
  { term: "Carburetor / Carburettor", definition: "The device that mixes fuel and air in the correct ratio for combustion in the engine. Adjusted using the H (high speed), L (low speed), and idle screws. An incorrectly tuned carburettor causes poor starting, chain creep at idle, or engine damage.", category: "Chainsaw Components" },
