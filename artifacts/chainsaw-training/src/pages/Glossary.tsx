...
const TERMS: { term: string; definition: string; category: string }[] = [
  ...
  { term: "TQT (Total Qualification Time)", definition: "The total number of hours a typical learner is expected to spend on a qualification, including guided learning, independent study, and assessment. This course has a TQT of 10 hours: 4 hours Guided Learning (GLH), 4 hours Independent Self-Study, and 2 hours Directed Assessment.", category: "Training & Assessment" },
