    ...
    <>
      ...
      <header className="border-b border-border bg-card/60 backdrop-blur sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          >
            {downloading
              ? <Loader2 className="w-3 h-3 text-[#e27226] animate-spin" />
              : <FileDown className="w-3 h-3 text-[#e27226]" />}
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 prose prose-sm prose-neutral max-w-none">
        ...
        <div className="space-y-7 text-sm leading-relaxed text-foreground font-mono">
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">1. Who We Are (Data Controller)</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">2. What Data We Collect and Why</h2>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">3. Professional Standards Context</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">4. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">5. Your Rights Under UK GDPR</h2>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">6. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">7. Third-Party Services</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-xs border-collapse border border-border">
                <thead>
                  <tr className="bg-muted">
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">8. Cookies &amp; Local Storage</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">9. Children</h2>
            <p>
          ...
          <section>
            <h2 className="font-black uppercase tracking-widest text-xs text-[#e27226] mb-2">10. Changes to This Policy</h2>
            <p>
