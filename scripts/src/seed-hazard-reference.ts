...
const HAZARDS: { category: "site" | "chainsaw" | "job"; hazard: string; controlMeasure: string }[] = [
  ...
  { category: "job", hazard: "Incorrect cutting techniques causing trapped bars or timber splitting", controlMeasure: "Assess tension and compression forces in the timber, use wedges, and follow standard cross cutting techniques." },
